ServerEvents.recipes((event) => {
    ...
    event.shaped('ars_nouveau:scribes_table', ['PLP', 'TGT', 'A A'], {
    ...
    event.shaped('ars_nouveau:enchanting_apparatus', ['GDG', 'OCT', 'GDG'], {
    ...
    event.shaped('ars_nouveau:arcane_core', ['SDS', 'GAG', 'SDS'], {
        D: 'gtceu:sourcemetall_plate',
        S: 'ars_nouveau:sourcestone',
        A: 'ars_nouveau:abjuration_essence',
        G: 'gtceu:managold_plate',
    });
    event.shaped('ars_nouveau:imbuement_chamber', ['WGW', 'W W', 'WGW'], {
        W: 'gtceu:archwood_plate',
        G: 'gtceu:managold_plate',
    });
    event.shaped('ars_nouveau:arcane_pedestal', ['SQS', ' S ', 'GSG'], {
        S: 'ars_nouveau:sourcestone',
        G: 'gtceu:managold_plate',
        Q: 'botania:quartz_mana',
    });
    event.shaped('ars_nouveau:source_jar', ['SGS', 'M M', 'SGS'], {
