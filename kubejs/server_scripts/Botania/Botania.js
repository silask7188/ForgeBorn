...
ServerEvents.recipes((event) => {
    ...
    // Diluted Pool
    event.shaped('botania:diluted_pool', [' H ', 'LML', 'LLL'], {
    ...
    // Walking Cane
    event.shaped('extrabotany:walking_cane', [' GB', ' BG', 'B  '], {
        B: 'minecraft:bone',
        G: '#forge:foils/gold',
    });

    // Apothecary
    event.shaped('botania:apothecary_default', ['SBS', 'MCH', 'CCC'], {
    ...
    // Mana Spreader
    event.shaped('botania:mana_spreader', ['PLP', 'RGE', 'PLP'], {
    ...
    // Livingwood Bow
    event.shaped('botania:livingwood_bow', ['HTM', 'TOM', 'FTM'], {
