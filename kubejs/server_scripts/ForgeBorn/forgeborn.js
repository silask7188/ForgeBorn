ServerEvents.recipes((event) => {
    ...
    event.shaped(Item.of('4x gtceu:cobblestone_ingot'), ['   ', ' C ', ' F '], {
        C: 'minecraft:cobblestone',
        F: '#gtceu:tools/crafting_files',
    });
    event.shaped(Item.of('kubejs:rope'), [' S ', ' S ', ' S '], {
        S: 'minecraft:string',
    });

    event.shaped(Item.of('kubejs:cloth'), [' SN', 'SSS', ' S '], {
        S: 'minecraft:string',
        N: 'kubejs:needle',
    });

    event.shaped(Item.of('gtceu:cobblestone_file'), [' C ', ' C ', ' S '], {
        C: 'minecraft:cobblestone',
        S: 'minecraft:stick',
    });
    event.shaped(
    ...
    event
        .shaped(Item.of('minecraft:string', 3), ['   ', ' S ', ' B '], {
            S: 'minecraft:shears',
            B: 'kubejs:wool_clutch',
        })
        .damageIngredient('minecraft:shears');
    event
        .shaped(Item.of('kubejs:wool_clutch', 4), ['   ', ' S ', ' B '], {
            S: 'minecraft:shears',
            B: '#forge:wool',
        })
        .damageIngredient('minecraft:shears');

    event.shaped('kubejs:tanned_leather', [' S ', 'SLS', ' S '], {
        L: 'minecraft:leather',
        S: 'minecraft:string',
    });
    ...
    //ULV
    event.shaped('gtceu:ulv_bender', ['EPE', 'VHV', 'MCM'], {
    ...
    event.shaped('gtceu:ulv_centrifuge', ['VMV', 'CHC', 'VMV'], {
        H: 'gtceu:ulv_machine_hull',
        C: 'gtceu:red_alloy_single_cable',
        M: 'ulvcovm:ulv_electric_motor',
        V: 'gtceu:vacuum_tube',
    });
    event.shaped('gtceu:ulv_wiremill', ['MCM', 'VHV', 'MCM'], {
        H: 'gtceu:ulv_machine_hull',
        C: 'gtceu:red_alloy_single_cable',
        M: 'ulvcovm:ulv_electric_motor',
        V: 'gtceu:vacuum_tube',
    });
    event.shaped('gtceu:ulv_cutter', ['CVG', 'OHS', 'VCM'], {
        H: 'gtceu:ulv_machine_hull',
        G: 'minecraft:glass',
        C: 'gtceu:red_alloy_single_cable',
        M: 'ulvcovm:ulv_electric_motor',
    ...
    event.shaped('gtceu:ulv_extruder', ['WWV', 'PHC', 'WWV'], {
        H: 'gtceu:ulv_machine_hull',
    ...
    event.shaped('gtceu:ulv_chemical_reactor', ['GTG', 'CMC', 'VHV'], {
        H: 'gtceu:ulv_machine_hull',
        G: 'minecraft:glass',
        C: 'gtceu:red_alloy_single_cable',
        M: 'ulvcovm:ulv_electric_motor',
    ...
    event.shaped('gtceu:mana_pulse_infuser', ['RMR', 'CHC', 'VOV'], {
        H: 'gtceu:ulv_machine_hull',
    ...
    event.shaped('gtceu:sawmill', ['MSM', 'UHU', 'CCC'], {
    ...
    event.shaped('gtceu:cognitium_solidifier', ['MSM', 'UPU', 'CHC'], {
        H: 'gtceu:ulv_machine_hull',
    ...
    event.shaped('gtceu:lava_furnace', ['PPP', 'UHU', 'PCP'], {
        H: 'gtceu:ulv_machine_hull',
        P: 'kubejs:solid_wrought_iron_casing',
        U: '#gtceu:circuits/ulv',
        C: 'gtceu:lead_quadruple_cable',
    });
    event.shaped('gtceu:electric_cloche', ['SLS', 'UHU', 'PCP'], {
        H: 'gtceu:ulv_machine_hull',
        P: 'kubejs:solid_wrought_iron_casing',
        U: '#gtceu:circuits/ulv',
