ServerEvents.recipes((event) => {
    ...
    event.shaped('farmersdelight:stove', ['PPP', 'WCW', 'WHW'], {
        P: 'gtceu:steel_rod',
        W: 'minecraft:bricks',
        H: '#forge:tools/hammers',
        C: 'minecraft:campfire',
    });
    event.shaped('farmersdelight:cooking_pot', ['L L', 'PHP', 'PPP'], {
        P: 'gtceu:steel_plate',
        H: '#forge:tools/hammers',
        L: 'minecraft:leather',
    });
    event.remove({ output: 'farmersdelight:skillet' });
    event.shaped('farmersdelight:skillet', [' PP', 'FPP', 'SH '], {
    ...
    event.shaped('farmersdelight:iron_knife', ['FIH', ' S ', '   '], {
        I: '#forge:plates/iron',
        H: '#forge:tools/hammers',
        F: '#forge:tools/files',
        S: 'gtceu:treated_wood_rod',
    ...
    event.shaped('farmersdelight:golden_knife', ['FIH', ' S ', '   '], {
        I: '#forge:plates/gold',
        H: '#forge:tools/hammers',
        F: '#forge:tools/files',
        S: 'gtceu:treated_wood_rod',
    ...
    event.shaped('farmersdelight:diamond_knife', ['FIH', ' S ', '   '], {
    ...
    event.shaped('farmersdelight:netherite_knife', ['FIH', ' S ', '   '], {
