ServerEvents.recipes((event) => {
    ...
    // Casings
    event.shaped('gtceu:bronze_brick_casing', ['PPP', 'DHD', 'BBB'], {
        B: 'minecraft:bricks',
    ...
    event.shaped('gtceu:bronze_machine_casing', ['PPP', 'DHD', 'PPP'], {
        H: '#forge:tools/hammers',
        D: '#forge:double_plates/bronze',
        P: '#forge:plates/bronze',
    });
    ...
    event.shaped('gtceu:industrial_steam_casing', ['PHP', 'PFP', 'PWP'], {
    ...
    event.shaped('gtceu:steel_brick_casing', ['SSS', 'SHS', 'CCC'], {
        H: '#forge:tools/hammers',
        C: 'gtceu:firebricks',
    ...
    // Machines & Components
    event.shaped('kubejs:wrought_iron_firebox', ['PRP', 'RFR', 'PRP'], {
        P: '#forge:plates/steel',
        R: 'gtceu:wrought_iron_rod',
        F: 'gtceu:ulv_machine_casing',
    });

    event.shaped('gtceu:primitive_assembler', ['SCS', 'RAR', 'SCS'], {
    ...
    event.shaped('kubejs:solid_wrought_iron_casing', ['HPS', 'PCP', 'SPF'], {
    ...
    // HP Steam Machines
    event.shaped('gtceu:hp_steam_rock_crusher', ['SSS', 'PIP', 'SCS'], {
        P: 'gtceu:steel_gear',
    ...
    event.shaped('gtceu:hp_steam_alloy_smelter', ['SPS', 'SIS', 'SCS'], {
    ...
    event.shaped('gtceu:hp_steam_furnace', ['PSP', 'SIS', 'PCP'], {
        P: 'gtceu:tin_alloy_small_fluid_pipe',
    ...
    event.shaped('gtceu:hp_steam_macerator', ['PPP', 'SIS', 'PCP'], {
        P: '#forge:plates/steel',
    ...
    event.shaped('gtceu:hp_steam_forge_hammer', ['SSS', 'PIP', 'SCS'], {
        P: 'gtceu:tin_alloy_small_fluid_pipe',
    ...
    event.shaped('gtceu:hp_steam_compressor', ['PSP', 'SIS', 'PCP'], {
        P: 'gtceu:tin_alloy_small_fluid_pipe',
    ...
    event.shaped('gtceu:hp_steam_extractor', ['PSP', 'SIS', 'PCP'], {
        P: 'gtceu:tin_alloy_small_fluid_pipe',
        I: 'minecraft:piston',
    ...
    event.shaped('gtceu:hp_steam_solid_boiler', ['SSS', 'SWS', 'CFC'], {
        W: '#forge:tools/wrenches',
        F: 'minecraft:furnace',
        C: 'gtceu:firebricks',
        S: '#forge:plates/steel',
    ...
    event.shaped('2x gtceu:resin_circuit_board', [' R ', ' C ', ' R '], {
        R: 'gtceu:ditchbulb_resin_plate',
        C: 'gtceu:wood_plate',
    });

    event.shaped('6x gtceu:resin_circuit_board', ['RRR', 'CCC', 'RRR'], {
        R: 'gtceu:ditchbulb_resin_plate',
        C: 'gtceu:wood_plate',
    });
    ...
    event.shaped('2x gtceu:resistor', ['SPS', 'WCW', ' P '], {
    ...
    event.shaped('kubejs:not_vacuum_tube', ['ABA', 'CDC', ' C '], {
        A: 'gtceu:steel_bolt',
        B: 'gtceu:glass_tube',
    ...
    event.shaped('gtceu:ulv_machine_casing', ['AAA', 'ABA', 'AAA'], {
    ...
    event.shaped('gtceu:ulv_steam_turbine', ['PIP', 'RHR', 'MCM'], {
    ...
    event.shaped('gtceu:ulv_combustion_generator', ['PIP', 'MHM', 'GCG'], {
    ...
    event.shaped('gtceu:ulv_input_bus', [' I ', ' H ', '   '], {
        I: '#forge:chests/wooden',
        H: 'gtceu:ulv_machine_hull',
    });

    event.shaped('gtceu:ulv_output_bus', [' H ', ' I ', '   '], {
        I: '#forge:chests/wooden',
        H: 'gtceu:ulv_machine_hull',
    });

    event.shaped('gtceu:ulv_input_hatch', [' I ', ' H ', '   '], {
        I: '#forge:glass',
        H: 'gtceu:ulv_machine_hull',
    });

    event.shaped('gtceu:ulv_output_hatch', [' H ', ' I ', '   '], {
        I: '#forge:glass',
        H: 'gtceu:ulv_machine_hull',
    });
    ...
    // Casings & Hulls
    event.shaped('gtceu:lv_machine_casing', ['PSP', 'SWS', 'PSP'], {
        W: '#forge:tools/wrenches',
        S: 'gtceu:cloggrumsteel_plate',
        P: '#forge:plates/steel',
    });

    event.shaped('gtceu:lv_machine_hull', ['STS', 'ACA', '   '], {
        T: 'gtceu:steel_plate',
        S: 'gtceu:cloggrumsteel_plate',
    ...
    event.shaped('gtceu:lv_hermetic_casing', ['PSP', 'SWS', 'PSP'], {
    ...
    // Machines
    event.shaped('gtceu:lv_mixer', ['GRG', 'GMG', 'CHC'], {
        R: 'gtceu:tin_rotor',
