...
ServerEvents.recipes((event) => {
    ...
    event.shaped('usefulbackpacks:backpack_small', ['RIR', 'LSL', 'LLL'], {
        R: 'kubejs:rope',
        I: 'gtceu:iron_ring',
        L: 'kubejs:tanned_leather',
        S: 'minecraft:string',
    });
    event.shaped('usefulbackpacks:backpack_medium', ['RIR', 'LSL', 'LLL'], {
        R: 'kubejs:rope',
        I: 'gtceu:iron_ring',
        L: 'kubejs:tanned_leather',
        S: 'usefulbackpacks:backpack_small',
    });
    event.shaped('usefulbackpacks:backpack_large', ['RIR', 'LSL', 'LLL'], {
        R: 'kubejs:rope',
        I: 'gtceu:iron_ring',
        L: 'kubejs:tanned_leather',
